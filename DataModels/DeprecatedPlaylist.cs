...
{
    public class DeprecatedPlaylist : INotifyPropertyChanged
    {
        ...
        public static DeprecatedPlaylist Parse(JToken data)
        {
            return new DeprecatedPlaylist
            {
